...
"""
Exp02 IR-only YOLO11s 960 - Official-spec Validation

使用：
    runs/exp02_ir_yolo11s_960/weights/best.pt
...
EXPERIMENT_NAME = "val_exp02_ir_yolo11s_960"
...
def check_files():
    ...
    if output_dir.exists():
        raise FileExistsError(
            ...
            f"{output_dir}\n\n"
            "If you explicitly want to rerun it, remove "
...
def main():
    ...
    print("=" * 80)
    print("Exp02 IR YOLO11s 960 - Official-spec Validation")
    print("=" * 80)
    ...
    if all_ap.ndim != 2:
        raise RuntimeError(
            f"Unexpected all_ap shape: {all_ap.shape}"
        )
